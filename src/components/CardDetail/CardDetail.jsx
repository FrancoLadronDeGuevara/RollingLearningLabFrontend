      ...
      <Box>
        ...
        >
          ...
          >
            ...
            <Typography title="Fecha" sx={stylesText}>
              {workOrEven?.date}
            </Typography>
            ...
            |<ThumbUpOutlinedIcon />
            <Typography title="Likes" sx={stylesText}>
              {workOrEven?.likes.length ?? 0}
            </Typography>
          </Box>
          <Box>
            <Typography
              sx={{ fontSize: "1rem", fontWeight: "600", color: "#3D3D3D" }}
              component="h2"
            >
              Descripción
            </Typography>
          ...
          <Box sx={{width:{md:"15vw"}}}>
            <DefaultButton
              onclick={() => console.log("click Defualtbutton")}
              buttonText={
                workOrEven?.status === "PENDIENTE" ? "registrarse" : "ver"
              }
              styles={{width:"100%", padding: ".8rem" }}
            />
          </Box>
        </Box>
        {/*!TODO: separar boton */}

...
const RegisterForm = () => {
  ...
  const handleSubmit = () => {
    ...
    dispatch(createUser({ email, password }))
      ...
      .then(() => {
        ...
        resetPassword();
        setConfirmPassword("");
        showAlert( "En breve recibirás un correo para activar tu cuenta", "success");
  ...
  return (
    <>
      ...
      <Container maxWidth={false}
        ...
        <Grid container maxWidth="sm">
          <Grid item xs={12}
            ...
            <Box component="img" src={logoRollingCode}
          ...
          <Grid item xs={12} sm={6}
            ...
            <FormControl fullWidth required variant="outlined" sx={{ mt: 2 }}>
              ...
              {showPassword ? 
              (<VisibilityOff sx={confIcon} onClick={() => setShowPassword(false)}/>) 
              : 
              (<Visibility sx={confIcon} onClick={() => setShowPassword(true)}/>)}
            </FormControl>
            ...
            <FormControl fullWidth required variant="outlined" sx={{ mt: 2 }}>
              ...
              {showConfirmPassword ? 
              (<VisibilityOff sx={confIcon} onClick={() => setShowConfirmPassword(false)}/>) 
                : 
              (<Visibility sx={confIcon} onClick={() => setShowConfirmPassword(true)}/>)}
            </FormControl>
            <Button
          ...
          <Grid item xs={12} sm={6}
            ...
            <Box sx={{ mb: 2 }}>
              <Typography variant="body1"
                ...
                <a href="https://web.rollingcodeschool.com/terminos-y-condiciones/"
                  target="_blank" style={{ color: "#5FA3E0" }}>
            ...
            <Typography variant="body1" sx={{ color: "gray" }}>
              ...
              <Link to="/login"
                style={{color: "#5FA3E0", textDecoration: "none", marginLeft: 5 }}>
                Inicia sesión
              </Link>
            </Typography>
          </Grid>
      ...
      {alert.open && (
        <PopupAlert open={alert.open} message={alert.message} color={alert.severity} onClose={hideAlert}/>
      )}
    </>
  );
};
